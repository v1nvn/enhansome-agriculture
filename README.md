...
* [iem](https://github.com/akrherz/iem) ⭐ 179 | 🐛 106 | 🌐 Python | 📅 2026-02-09 - Code that makes the Iowa Environmental Mesonet run.
...
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 96 | 🐛 27 | 🌐 R | 📅 2026-02-04 - R library for simplified access to NCSS soil databases.
...
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2025-12-03 - Node.js MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-01-14 - CSharp JDLink Machine Data API client example.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 195 | 🐛 42 | 🌐 JavaScript | 📅 2026-02-10 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Raster Vision](https://github.com/azavea/raster-vision) ⭐ 2,199 | 🐛 41 | 🌐 Python | 📅 2025-09-29 - Deep learning for aerial/satellite imagery.
