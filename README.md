...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,712 | 🐛 5 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 782 | 🐛 26 | 🌐 C++ | 📅 2026-03-02 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 184 | 🐛 108 | 🌐 Python | 📅 2026-03-30 - Code that makes the Iowa Environmental Mesonet run.
...
* [CropHarvest](https://github.com/nasaharvest/cropharvest) ⭐ 230 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2024-04-30 - Open source remote sensing dataset for global crop type mapping with 95,186 labeled datapoints from satellite imagery, supporting machine learning research for food security.
...
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-27 - Node.js MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-03-27 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,249 | 🐛 52 | 🌐 PHP | 📅 2026-03-21 - Web-based farm record keeping application built with Drupal and PHP.
...
* [Ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 470 | 🐛 3 | 🌐 Ruby | 📅 2026-03-30 - Farm management information system for farmers and small enterprises built with Ruby on Rails and PostgreSQL/PostGIS.
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 204 | 🐛 41 | 🌐 JavaScript | 📅 2026-03-29 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,254 | 🐛 20 | 📅 2026-03-29 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [pyshp](https://github.com/GeospatialPython/pyshp) ⭐ 1,151 | 🐛 30 | 🌐 Python | 📅 2026-03-19 - Reads and writes ESRI Shapefiles in pure Python.
...
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 447 | 🐛 20 | 🌐 Python | 📅 2026-03-20 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 839 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2025-07-28 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 774 | 🐛 112 | 🌐 Python | 📅 2026-03-27 - Plant phenotyping software using computer vision.
...
* [AgML](https://github.com/Project-AgML/AgML) ⭐ 271 | 🐛 12 | 🌐 Python | 📅 2026-03-17 - Centralized framework for agricultural machine learning.
* [agridat](https://github.com/kwstat/agridat) ⭐ 141 | 🐛 0 | 🌐 R | 📅 2026-03-29 - R package providing an extensive collection of datasets from agricultural experiments.
...
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 579 | 🐛 2 | 📅 2025-02-20 - A curated list of awesome tools, tutorials and APIs related to data from the Copernicus Sentinel Satellites.
