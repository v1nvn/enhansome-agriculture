...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,738 | 🐛 4 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 793 | 🐛 26 | 🌐 C++ | 📅 2026-03-02 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 185 | 🐛 107 | 🌐 Python | 📅 2026-04-23 - Code that makes the Iowa Environmental Mesonet run.
...
* [CWFID](https://github.com/cwfid/dataset) ⭐ 159 | 🐛 0 | 📅 2015-04-20 - Dataset comprising field images, vegetation segmentation masks and crop/weed plant type annotations.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,264 | 🐛 53 | 🌐 PHP | 📅 2026-04-16 - Web-based farm record keeping application built with Drupal and PHP.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 207 | 🐛 50 | 🌐 JavaScript | 📅 2026-04-23 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,320 | 🐛 28 | 📅 2026-03-29 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 784 | 🐛 116 | 🌐 Python | 📅 2026-04-22 - Plant phenotyping software using computer vision.
