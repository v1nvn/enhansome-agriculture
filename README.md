# Awesome Agriculture [![Awesome](https://awesome.re/badge.svg)](https://awesome.re) with stars
...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,704 | 🐛 5 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 776 | 🐛 26 | 🌐 C++ | 📅 2026-03-02 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [farm-calculators](https://github.com/brycejohnston/farm-calculators) ⭐ 21 | 🐛 0 | 🌐 PHP | 📅 2017-05-01 - WordPress plugin for calculating various farming and crop related information.

## Climate, Environment and Weather

* [iem](https://github.com/akrherz/iem) ⭐ 183 | 🐛 107 | 🌐 Python | 📅 2026-03-20 - Code that makes the Iowa Environmental Mesonet run.
...
* [pyTSEB](https://github.com/hectornieto/pyTSEB) ⭐ 163 | 🐛 4 | 🌐 Python | 📅 2025-12-16 - A python two source energy balance model for estimation of evapotranspiration with remote sensing data.
* [GSODR](https://github.com/ropensci/GSODR) ⭐ 98 | 🐛 0 | 🌐 R | 📅 2026-03-18 - Global summary daily weather data in R.
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 96 | 🐛 28 | 🌐 R | 📅 2026-03-17 - R library for simplified access to NCSS soil databases.
...
* [CropHarvest](https://github.com/nasaharvest/cropharvest) ⭐ 228 | 🐛 36 | 🌐 Jupyter Notebook | 📅 2024-04-30 - Open source remote sensing dataset for global crop type mapping with 95,186 labeled datapoints from satellite imagery, supporting machine learning research for food security.
...
* [CWFID](https://github.com/cwfid/dataset) ⭐ 157 | 🐛 0 | 📅 2015-04-20 - Dataset comprising field images, vegetation segmentation masks and crop/weed plant type annotations.
...
* [SampleData](https://github.com/JohnDeere/SampleData) ⭐ 34 | 🐛 0 | 📅 2023-03-29 - Sample datacards, shapefiles, and other files you can use for testing.
* [MyJohnDeereAPI-OAuth2-Python-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Python-Example) ⭐ 20 | 🐛 2 | 🌐 Python | 📅 2026-02-20 - Python MyJohnDeere API client example.
* [Botanica](https://github.com/Michael-A-Kuykendall/botanica) ⭐ 10 | 🐛 1 | 🌐 Rust | 📅 2025-09-14 - Production-ready Rust crate for professional botanical data management with taxonomic hierarchy, cultivation tracking, and Darwin Core compliance.
...
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-02-18 - Node.js MyJohnDeere API client example.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 2 | 🐛 9 | 🌐 Java | 📅 2026-03-19 - Java MyJohnDeere API client example.
* [ClearAg-API-Examples](https://github.com/IterisClearAg/ClearAg-API-Examples) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2018-10-17 - A collection of code examples using the ClearAg APIs.
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-03-12 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,244 | 🐛 52 | 🌐 PHP | 📅 2026-03-20 - Web-based farm record keeping application built with Drupal and PHP.
...
* [Ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 468 | 🐛 3 | 🌐 Ruby | 📅 2024-03-11 - Farm management information system for farmers and small enterprises built with Ruby on Rails and PostgreSQL/PostGIS.
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 204 | 🐛 41 | 🌐 JavaScript | 📅 2026-03-19 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,240 | 🐛 24 | 📅 2026-03-06 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [pyshp](https://github.com/GeospatialPython/pyshp) ⭐ 1,150 | 🐛 30 | 🌐 Python | 📅 2026-03-19 - Reads and writes ESRI Shapefiles in pure Python.
* [rgeo-shapefile](https://github.com/rgeo/rgeo-shapefile) ⭐ 98 | 🐛 4 | 🌐 Ruby | 📅 2024-10-10 - RGeo Shapefile is an optional module for RGeo for reading geospatial data from ESRI shapefiles in Ruby.

## IoT, Hardware

* [Farm-Data-Relay-System](https://github.com/timmbogner/Farm-Data-Relay-System) ⭐ 600 | 🐛 6 | 🌐 C | 📅 2026-01-29 - System using ESP-NOW, LoRa, and other protocols to transport sensor data in remote areas without relying on WiFi.
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 444 | 🐛 20 | 🌐 Python | 📅 2026-03-20 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 837 | 🐛 34 | 🌐 Jupyter Notebook | 📅 2025-07-28 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 771 | 🐛 110 | 🌐 Python | 📅 2026-03-20 - Plant phenotyping software using computer vision.
...
* [AgML](https://github.com/Project-AgML/AgML) ⭐ 267 | 🐛 11 | 🌐 Python | 📅 2026-03-17 - Centralized framework for agricultural machine learning.
* [agridat](https://github.com/kwstat/agridat) ⭐ 140 | 🐛 0 | 🌐 R | 📅 2026-03-07 - R package providing an extensive collection of datasets from agricultural experiments.
...
* [Raster Vision](https://github.com/azavea/raster-vision) ⭐ 2,209 | 🐛 41 | 🌐 Python | 📅 2025-09-29 - Deep learning for aerial/satellite imagery.
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 576 | 🐛 1 | 📅 2025-02-20 - A curated list of awesome tools, tutorials and APIs related to data from the Copernicus Sentinel Satellites.
