...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,699 | 🐛 4 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 773 | 🐛 26 | 🌐 C++ | 📅 2026-03-02 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 183 | 🐛 107 | 🌐 Python | 📅 2026-03-16 - Code that makes the Iowa Environmental Mesonet run.
...
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 96 | 🐛 27 | 🌐 R | 📅 2026-03-16 - R library for simplified access to NCSS soil databases.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 2 | 🐛 9 | 🌐 Java | 📅 2026-03-14 - Java MyJohnDeere API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,243 | 🐛 51 | 🌐 PHP | 📅 2026-03-16 - Web-based farm record keeping application built with Drupal and PHP.
...
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 203 | 🐛 37 | 🌐 JavaScript | 📅 2026-03-16 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,235 | 🐛 22 | 📅 2026-03-06 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [pyshp](https://github.com/GeospatialPython/pyshp) ⭐ 1,148 | 🐛 32 | 🌐 Python | 📅 2025-11-28 - Reads and writes ESRI Shapefiles in pure Python.
...
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 768 | 🐛 108 | 🌐 Python | 📅 2026-03-16 - Plant phenotyping software using computer vision.
...
* [Awesome Sentinel](https://github.com/Fernerkundung/awesome-sentinel) ⭐ 577 | 🐛 1 | 📅 2025-02-20 - A curated list of awesome tools, tutorials and APIs related to data from the Copernicus Sentinel Satellites.
* [Sen2Agri](https://github.com/Sen2Agri/Sen2Agri-System) ⭐ 128 | 🐛 23 | 🌐 HTML | 📅 2020-11-23 - Software system processing high resolution satellite images for agricultural purposes.
