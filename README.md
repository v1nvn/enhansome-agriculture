...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,735 | 🐛 4 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 792 | 🐛 26 | 🌐 C++ | 📅 2026-03-02 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [farm-calculators](https://github.com/brycejohnston/farm-calculators) ⭐ 22 | 🐛 0 | 🌐 PHP | 📅 2017-05-01 - WordPress plugin for calculating various farming and crop related information.

## Climate, Environment and Weather

* [iem](https://github.com/akrherz/iem) ⭐ 185 | 🐛 107 | 🌐 Python | 📅 2026-04-20 - Code that makes the Iowa Environmental Mesonet run.
...
* [pyTSEB](https://github.com/hectornieto/pyTSEB) ⭐ 161 | 🐛 4 | 🌐 Python | 📅 2025-12-16 - A python two source energy balance model for estimation of evapotranspiration with remote sensing data.
* [GSODR](https://github.com/ropensci/GSODR) ⭐ 99 | 🐛 0 | 🌐 R | 📅 2026-04-04 - Global summary daily weather data in R.
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 98 | 🐛 29 | 🌐 R | 📅 2026-04-17 - R library for simplified access to NCSS soil databases.
* [agroclimatology](https://github.com/brycejohnston/agroclimatology) ⭐ 18 | 🐛 1 | 🌐 Ruby | 📅 2017-08-30 - Ruby client for interacting with the NASA (POWER) Agroclimatology Web Resource.
...
* [CropHarvest](https://github.com/nasaharvest/cropharvest) ⭐ 231 | 🐛 37 | 🌐 Jupyter Notebook | 📅 2024-04-30 - Open source remote sensing dataset for global crop type mapping with 95,186 labeled datapoints from satellite imagery, supporting machine learning research for food security.
...
* [CWFID](https://github.com/cwfid/dataset) ⭐ 158 | 🐛 0 | 📅 2015-04-20 - Dataset comprising field images, vegetation segmentation masks and crop/weed plant type annotations.
...
* [SampleData](https://github.com/JohnDeere/SampleData) ⭐ 35 | 🐛 0 | 📅 2023-03-29 - Sample datacards, shapefiles, and other files you can use for testing.
* [MyJohnDeereAPI-OAuth2-Python-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Python-Example) ⭐ 21 | 🐛 2 | 🌐 Python | 📅 2026-02-20 - Python MyJohnDeere API client example.
* [Botanica](https://github.com/Michael-A-Kuykendall/botanica) ⭐ 12 | 🐛 1 | 🌐 Rust | 📅 2025-09-14 - Production-ready Rust crate for professional botanical data management with taxonomic hierarchy, cultivation tracking, and Darwin Core compliance.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 3 | 🐛 9 | 🌐 Java | 📅 2026-04-19 - Java MyJohnDeere API client example.
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-04-16 - Node.js MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-04-14 - CSharp JDLink Machine Data API client example.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,264 | 🐛 52 | 🌐 PHP | 📅 2026-04-16 - Web-based farm record keeping application built with Drupal and PHP.
...
* [Ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 475 | 🐛 6 | 🌐 Ruby | 📅 2026-04-15 - Farm management information system for farmers and small enterprises built with Ruby on Rails and PostgreSQL/PostGIS.
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 207 | 🐛 48 | 🌐 JavaScript | 📅 2026-04-21 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,316 | 🐛 27 | 📅 2026-03-29 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [pyshp](https://github.com/GeospatialPython/pyshp) ⭐ 1,152 | 🐛 30 | 🌐 Python | 📅 2026-03-19 - Reads and writes ESRI Shapefiles in pure Python.
...
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 457 | 🐛 14 | 🌐 Python | 📅 2026-04-20 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 856 | 🐛 39 | 🌐 Jupyter Notebook | 📅 2025-07-28 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 783 | 🐛 114 | 🌐 Python | 📅 2026-04-20 - Plant phenotyping software using computer vision.
...
* [AgML](https://github.com/Project-AgML/AgML) ⭐ 276 | 🐛 12 | 🌐 Python | 📅 2026-03-17 - Centralized framework for agricultural machine learning.
...
* [Raster Vision](https://github.com/azavea/raster-vision) ⭐ 2,213 | 🐛 41 | 🌐 Python | 📅 2025-09-29 - Deep learning for aerial/satellite imagery.
...
* [Sen2Agri](https://github.com/Sen2Agri/Sen2Agri-System) ⭐ 129 | 🐛 23 | 🌐 HTML | 📅 2020-11-23 - Software system processing high resolution satellite images for agricultural purposes.
