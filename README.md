...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,705 | 🐛 5 | 📅 2026-01-05.
...
* [Fields2Cover](https://github.com/Fields2Cover/Fields2Cover) ⭐ 778 | 🐛 26 | 🌐 C++ | 📅 2026-03-02 - Robust and efficient coverage paths for autonomous agricultural vehicles.
...
* [iem](https://github.com/akrherz/iem) ⭐ 183 | 🐛 107 | 🌐 Python | 📅 2026-03-22 - Code that makes the Iowa Environmental Mesonet run.
...
* [farmOS](https://github.com/farmOS/farmOS) ⭐ 1,246 | 🐛 52 | 🌐 PHP | 📅 2026-03-21 - Web-based farm record keeping application built with Drupal and PHP.
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,241 | 🐛 28 | 📅 2026-03-06 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 445 | 🐛 20 | 🌐 Python | 📅 2026-03-20 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 838 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2025-07-28 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
...
* [agridat](https://github.com/kwstat/agridat) ⭐ 141 | 🐛 0 | 🌐 R | 📅 2026-03-07 - R package providing an extensive collection of datasets from agricultural experiments.
