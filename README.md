...
Contributions welcome! Please follow the [contributing guidelines](https://github.com/beaorn/awesome-agriculture/blob/master/contributing.md) ⭐ 1,714 | 🐛 5 | 📅 2026-01-05.
...
* [iem](https://github.com/akrherz/iem) ⭐ 184 | 🐛 107 | 🌐 Python | 📅 2026-03-31 - Code that makes the Iowa Environmental Mesonet run.
...
* [soilDB](https://github.com/ncss-tech/soilDB) ⭐ 96 | 🐛 28 | 🌐 R | 📅 2026-03-31 - R library for simplified access to NCSS soil databases.
...
* [Botanica](https://github.com/Michael-A-Kuykendall/botanica) ⭐ 11 | 🐛 1 | 🌐 Rust | 📅 2025-09-14 - Production-ready Rust crate for professional botanical data management with taxonomic hierarchy, cultivation tracking, and Darwin Core compliance.
...
* [MyJohnDeereAPI-OAuth2-NodeJS-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-NodeJS-Example) ⭐ 3 | 🐛 25 | 🌐 JavaScript | 📅 2026-03-30 - Node.js MyJohnDeere API client example.
...
* [MyJohnDeereAPI-OAuth2-Java-Example](https://github.com/JohnDeere/MyJohnDeereAPI-OAuth2-Java-Example) ⭐ 2 | 🐛 9 | 🌐 Java | 📅 2026-03-30 - Java MyJohnDeere API client example.
...
* [JDLinkMachineDataAPI-OAuth2-CSharp-Example](https://github.com/JohnDeere/JDLinkMachineDataAPI-OAuth2-CSharp-Example) ⭐ 0 | 🐛 7 | 🌐 C# | 📅 2026-03-30 - CSharp JDLink Machine Data API client example.
...
* [Ekylibre](https://github.com/ekylibre/ekylibre) ⭐ 471 | 🐛 3 | 🌐 Ruby | 📅 2026-03-30 - Farm management information system for farmers and small enterprises built with Ruby on Rails and PostgreSQL/PostGIS.
* [LiteFarm](https://github.com/LiteFarmOrg/LiteFarm) ⭐ 205 | 🐛 41 | 🌐 JavaScript | 📅 2026-04-01 - LiteFarm is the world’s first community-led, not-for-profit, Farm management system
...
* [Awesome GIS](https://github.com/sshuair/awesome-gis) ⭐ 5,260 | 🐛 20 | 📅 2026-03-29 - Awesome GIS is a list collecting abundant GIS related sources.
...
* [OpenWeedLocator](https://github.com/geezacoleman/OpenWeedLocator) ⭐ 448 | 🐛 20 | 🌐 Python | 📅 2026-03-31 - Open Source, low-cost, image-based weed detection device for in-crop and fallow scenarios.
...
* [FarmVibes.AI](https://github.com/microsoft/farmvibes-ai) ⭐ 845 | 🐛 35 | 🌐 Jupyter Notebook | 📅 2025-07-28 - Multi-Modal GeoSpatial ML Models for Agriculture and Sustainability.
* [PlantCV](https://github.com/danforthcenter/plantcv) ⭐ 774 | 🐛 112 | 🌐 Python | 📅 2026-03-30 - Plant phenotyping software using computer vision.
